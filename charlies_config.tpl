...
{combine_script id="jquery.ui" src=$ROOT_URL|@cat:"themes/default/js/ui/minified/jquery.ui.core.min.js"}
{combine_script id="jquery.ui.tabs" src=$ROOT_URL|@cat:"themes/default/js/ui/minified/jquery.ui.tabs.min.js"}
